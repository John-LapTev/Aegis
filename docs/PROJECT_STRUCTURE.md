...
│   │   ├── Models/                   #   Severity · ScanGroup · Finding · ScanResult · ScanProgress · FindingKinds(значения Data["kind"]) · FindingDataKeys(имена ключей Data) · AiResult · WebSearchResult · DeviceUpdateResult · DriverUpdateOffer(доступное обновление драйвера из Windows Update)
