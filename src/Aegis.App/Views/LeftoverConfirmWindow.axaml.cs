...
/// с галочками. «Удалить выбранное» возвращает отмеченные остатки, «Оставить» — пустой список. Файлы/папки удаляются
/// НАСОВСЕМ (окно предупреждает об этом текстом), записи реестра — с бэкапом (обратимы).
/// </summary>
